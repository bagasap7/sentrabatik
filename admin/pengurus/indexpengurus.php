    ...
    <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
      <div class="simplebar-content" style="padding: 0px;">
        ...
        <ul class="navbar-nav align-self-stretch">
          <li class="">
            <a class="nav-link text-left active" href="indexpengurus.php" role="button" aria-haspopup="true" aria-expanded="false" href="dashboard.php">
      ...
      <div id="content">
        <div class="container-fluid p-0 px-lg-0 px-md-0">
          ...
          <div class="container">
            ...
            <br><br><br><br><br><br>
            <center>
              <p>Anda Telah Login Sebagai Admin</p>
            </center>
            <center>
              <p>Selamat Bekerja Semoga Hari Kamu Menyenangkan :))</p>
            </center>
          </div>
        </div>
        <!-- /#wrapper -->
