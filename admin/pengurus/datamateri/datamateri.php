...
<head>
  ...
  <title>Materi Zona Batik Admin</title>
    ...
    <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
      <div class="simplebar-content" style="padding: 0px;">
        ...
        <ul class="navbar-nav align-self-stretch">
          ...
          <li class="">
            <a class="nav-link text-left active" href="datamateri.php" role="button">
        ...
        <div class="container-fluid p-0 px-lg-0 px-md-0">
          ...
          <div class="col tablesolo" style="color: #9c6644;">
            <table class="table table-responsive-md table-striped">
              <center>
                <h2><strong>Data Materi Zona Batik</strong></h2>
                <button class="tambah"><a style="color: #9c6644;" href="inputdatamateri.php">Tambah Data Materi Zona Batik</a></button>
              </center>
                ...
                <tr>
                  <center>
                    <th width="50px" scope="col">
                      <center>ID Materi</center>
                    </th>
                    <th width="160px" scope="col">Keterangan</th>
                    <th width="80px" scope="col">Kota</th>
                    <th width="320px" scope="col">
              ...
              <?php $i = 1; ?>
              <?php $result = mysqli_query($koneksi, "SELECT * FROM materi"); ?>
              <?php foreach ($result as $row) : ?>
                <tbody>
                  <tr>
                    <th>
                      <center><?= $row['id_materi']; ?></center>
                    </th>
                    <th><?= $row['keterangan']; ?></th>
                    <th><?= $row['id_kota']; ?></th>
                    <th><?= $row['materi']; ?></th>
                    <th>
                      <a href="editdatamateri.php?id=<?= $row['id_materi']; ?>">Edit</a> |
                      <a href="hapusdatamateri.php?id=<?= $row['id_materi']; ?>" onclick="return confirm('Yakin?');">Hapus</a>
                    </th>
                  </tr>
                </tbody>
                <?php $i++; ?>
