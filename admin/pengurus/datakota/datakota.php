    ...
    <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
      <div class="simplebar-content" style="padding: 0px;">
        ...
        <ul class="navbar-nav align-self-stretch">
          ...
          <li class="">
            <a class="nav-link text-left active" href="datakota.php" role="button">
          ...
          <div class="col tablesolo" style="color: #9c6644;">
            <table class="table table-responsive-md table-striped">
              <center>
                ...
                <button class="tambah"><a style="color: #9c6644;" href="inputdatakota.php">Tambah Data Zona Batik</a></button>
              </center>
              ...
              <?php $i = 1; ?>
              <?php $result = mysqli_query($koneksi, "SELECT * FROM kota"); ?>
              <?php foreach ($result as $row) : ?>
                <tbody>
                  <tr>
                    <th>
                      <center><?= $row['id_kota']; ?></center>
                    </th>
                    <th><?= $row['kota']; ?></th>
                    <th>
                      <a href="editdatakota.php?id=<?= $row['id_kota']; ?>">Edit</a> |
                      <a href="hapusdatakota.php?id=<?= $row['id_kota']; ?>" onclick="return confirm('Yakin?');">Hapus</a>
                    </th>
                  </tr>
                </tbody>
                <?php $i++; ?>
