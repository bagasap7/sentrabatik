...
<head>
  ...
  <title>Data Penjual Zona Batik</title>
  ...
  <div id="wrapper">
    ...
    <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
      <div class="simplebar-content" style="padding: 0px;">
        <a class="sidebar-brand" href="../indexpengurus.php">
          <span class="align-middle">Zona Batik</span>
        </a>
        <ul class="navbar-nav align-self-stretch">
          <li class="">
            <a class="nav-link text-left" href="../indexpengurus.php" role="button" aria-haspopup="true" aria-expanded="false" href="dashboard.php">
          ...
          <li class="">
            <a class="nav-link text-left active" href="datapenjual.php" role="button">
          ...
          <li class="">
            <a class="nav-link text-left" href="../datagallery/datagallery.php" role="button">
        ...
        <div class="container-fluid p-0 px-lg-0 px-md-0">
          ...
          <div class="col tablesolo" style="color: #9c6644;">
            <table class="table table-responsive-md table-striped">
              <center>
                <h2><strong>Data Penjual Zona Batik</strong></h2>
                <button class="tambah"><a style="color: #9c6644;" href="inputdatapenjual.php">Tambah Data Zona Batik</a></button>
              </center>
              ...
              <thead>
                <tr>
                  <th width="50px" scope="col">
                    <center>ID Penjual</center>
                  </th>
                  <th width="220px" scope="col">
                    <center>Nama Penjual/Sentra</center>
                  </th>
                  <th width="140px" scope="col">Kota</th>
                  <th width="140px" scope="col">Kontak Penjual</th>
                  <th width="400px" scope="col">
                    <center>Alamat Penjual</center>
                  </th>
              ...
              <?php foreach ($result as $row) : ?>
                <tbody>
                  <tr>
                    <th>
                      <center><?= $row['id_penjual']; ?></center>
                    </th>
                    <th><?= $row['nama_penjual']; ?></th>
                    <th><?= $row['id_kota']; ?></th>
                    <th><?= $row['kontak']; ?></th>
                    <th><?= $row['alamat']; ?></th>
                    <th>
                      <a href="editdatapenjual.php?id=<?= $row['id_penjual']; ?>">Edit</a> |
                      <a href="hapusdatapenjual.php?id=<?= $row['id_penjual']; ?>" onclick="return confirm('Yakin?');">Hapus</a>
                    </th>
                  </tr>
                </tbody>
                <?php $i++; ?>
